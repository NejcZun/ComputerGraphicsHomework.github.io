function Quadtree( limit, max_circles, max_levels, level) {
...
Quadtree.prototype.insert = function(circle) {  //inserti krog
	var i = 0;
	var index;
...
Quadtree.prototype.clear = function() { //kleara use iz polja
